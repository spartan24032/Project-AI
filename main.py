...
if __name__ == "__main__":
    ...
    pickups = {  # {(coordinate): starting capacity}
        (0,4): dropoffCapacity, (1,3): dropoffCapacity, (4,1): dropoffCapacity
                }
    ...
    agents = [
        ...
        Agent(a, start_state=(2,2), policy = PExploit, learning_algorithm="Q-learning", alpha=0.5, gamma=0.3),
        Agent(a, start_state=(4,2), policy=PExploit, learning_algorithm="Q-learning", alpha=0.3, gamma=0.5),
        Agent(a, start_state=(0,2), policy=PExploit, learning_algorithm="Q-learning", alpha=0.7, gamma=0.8)
    ]
    r = 100
